...
ev_parametric = []
parametric_labels = ['Content_or_Target_Word','instructions','No_Interest','PC1_Length_Content_or_Target',
                     'PC1_Length_Content_or_Target_Squared','Log_Freq_HAL_Content_or_Target',
                     'Log_Freq_HAL_Content_or_Target_Squared','Length',
...
datasink.inputs.base_directory = pardir + 'fMRI_Analyses/'
...
parametric_level2model = Node(fsl.model.L2Model(num_copes =5),
