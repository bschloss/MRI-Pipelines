...
FSFDIR = pardir + 'FSF/Parametric/Low_Level_Linear_ID/'
try:
    os.makedirs(FSFDIR)
except:
    exceptions.OSError
    
outputdir = pardir + 'fMRI_Analyses/Low_Level_Linear_ID/'  
runnum = 0
fsfs = []
design_mats = []
design_pngs = []
...
analysis = Workflow(name = "Low_Level_Linear_ID")
...
datasink.inputs.base_directory = pardir + 'fMRI_Analyses/Low_Level_Linear_ID'
