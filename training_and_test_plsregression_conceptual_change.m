...
sg_lo = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/lo_sg.mat');
load(sg_lo);
bow_lo = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/lo_bow.mat');
load(bow_lo);
sgbow_lo = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/lo_sgbow.mat');
load(sgbow_lo);
...
save_path = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/results.mat');
