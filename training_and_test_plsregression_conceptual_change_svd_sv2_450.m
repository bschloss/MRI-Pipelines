...
for i = 1:N
    ...
    actual_vector1 = squeeze(zscore(lo_response2_450(i,1,:)));
    actual_vector2 = squeeze(zscore(lo_response2_450(i,2,:)));
...
save_path = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/results_svd_sv2_450.mat');
