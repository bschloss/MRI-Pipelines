...
ev_parametric = []
parametric_labels = ['Content_or_Target_Word',
		     'first_instructions',
		     'No_Interest',
		     'PC1_Length_Content_or_Target',
                     'Log_Freq_HAL_Content_or_Target']
                     #'Length',
...
data = Node(ID(fields=['func','mp','ev_parametric',
                       ...
                       'func_trim_point','mask'],mandatory_inputs=False),name='Data')
...
datasink.inputs.base_directory = pardir + 'fMRI_Analyses/Low_Level_Linear/'
...
parametric_cluster23 = MapNode(interface=fsl.model.Cluster(out_localmax_txt_file = True,
                                                           out_localmax_vol_file = True,
                                                           out_index_file=True,
                                                           out_threshold_file = True,
                                                           threshold = 2.3),
                                        name = 'Parametric_Cluster_Z23',
                                        iterfield = ['in_file'])
analysis.connect(parametric_flameo,'zstats',parametric_cluster23,'in_file')
analysis.connect(parametric_cluster23,'index_file',datasink,'Parametric_Cluster_Z23_Index')
analysis.connect(parametric_cluster23,'localmax_txt_file',datasink,'Parametric_Cluster_Z23_LocalMax_Txt')
analysis.connect(parametric_cluster23,'localmax_vol_file',datasink,'Parametric_Cluster_Z23_LocalMax_Vol')
analysis.connect(parametric_cluster23,'threshold_file',datasink,'Parametric_Cluster_Z23_Threshold_File')
                                       
parametric_cluster31 = MapNode(interface=fsl.model.Cluster(out_localmax_txt_file = True,
                                                           out_index_file=True,
                                                           out_threshold_file = True,
                                                           threshold = 3.1),
                                        name = 'Parametric_Cluster_Z31',
                                        iterfield = ['in_file'])
analysis.connect(parametric_flameo,'zstats',parametric_cluster31,'in_file')
analysis.connect(parametric_cluster31,'index_file',datasink,'Parametric_Cluster_Z31_Index')
analysis.connect(parametric_cluster31,'localmax_txt_file',datasink,'Parametric_Cluster_Z31_LocalMax_Txt')
analysis.connect(parametric_cluster31,'localmax_vol_file',datasink,'Parametric_Cluster_Z31_LocalMax_Vol')
analysis.connect(parametric_cluster31,'threshold_file',datasink,'Parametric_Cluster_Z31_Threshold_File')
