...
load(sgbow_designs);
responses = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/response2_200.mat');
load(responses);
...
load(sgbow_lo);
response_lo = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/lo_response2_200.mat');
load(response_lo);

N = size(response2_200, 1); 
ncomp = 25;
correct = struct();
correct.('context') = 0;
correct.('order') = 0;
...
for i = 1:N
    ...
    y_matrix = squeeze(zscore(response2_200(i,:, :)));
    ...
    actual_vector1 = squeeze(zscore(lo_response2_200(i,1,:)));
    actual_vector2 = squeeze(zscore(lo_response2_200(i,2,:)));
...
save_path = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/results_svd_sv2_200.mat');
