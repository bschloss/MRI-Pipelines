...
pardirs = [datadir + d + '/fMRI_Analyses/Low_Level_Quad/' for d in pardirs]
parcopes = []
parvarcopes = []
pardof = []
...
data = Node(ID(fields=['parvarcopes','parcopes','pardof','mask','struct','design','grp','con'],mandatory_inputs=False),name='Data')
...
datasink.inputs.base_directory = datadir + '/Group_Analyses/Low_Level_Quad_MvB/'
