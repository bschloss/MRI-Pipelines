...
FSFDIR = pardir + 'FSF/Parametric/Full_Linear_ID/'
try:
    os.makedirs(FSFDIR)
except:
    exceptions.OSError
    
outputdir = pardir + 'fMRI_Analyses/Full_Linear_ID/'
runnum = 0
fsfs = []
design_mats = []
design_pngs = []
...
analysis = Workflow(name = "Full_Linear_ID")
...
datasink.inputs.base_directory = pardir + 'fMRI_Analyses/Full_Linear_ID'
