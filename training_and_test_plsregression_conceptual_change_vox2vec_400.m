...
for i = 1:N
    ...
    context_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_context;
    context_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_context;
    order_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_order;
    order_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_order;
    contextorder_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_contextorder;
    contextorder_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_contextorder;
    sg_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_sg;
    sg_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_sg;
    bow_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_bow;
    bow_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_bow;
    sgbow_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_sgbow;
    sgbow_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_sgbow;
    contextsgbow_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_contextsgbow;
    contextsgbow_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_contextsgbow;
    contextordersgbow_pred1 = [1 squeeze(zscore(lo_response2_400(i,1,:)))']*BETA_contextordersgbow;
    contextordersgbow_pred2 = [1 squeeze(zscore(lo_response2_400(i,2,:)))']*BETA_contextordersgbow;
...
save_path = strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/results_svd_sv2_400_vox2vec.mat');
