...
ev_parametric = []
labels = ['Content_or_Target_Word',
                     'first_instructions',
                     'No_Interest',
                     'PC1_Length_Content_or_Target',
                     'PC1_Length_Content_or_Target_Squared',
                     'Log_Freq_HAL_Content_or_Target',
                     'Log_Freq_HAL_Content_or_Target_Squared',
                     'Concreteness_Content_or_Target',
                     'Concreteness_Content_or_Target_Squared',
                     'AoA_Content_or_Target',
                     'AoA_Content_or_Target_Squared',
                     'Position_Content_or_Target']
                     #'Length',
...
FSFDIR = pardir + 'FSF/Parametric/Full_Quad_ID/'
try:
    os.makedirs(FSFDIR)
except:
    exceptions.OSError
    
outputdir = pardir + 'fMRI_Analyses/Full_Quad_ID/'
runnum = 0
fsfs = []
design_mats = []
design_pngs = []
...
analysis = Workflow(name = "Full_Quad_ID")
...
datasink.inputs.base_directory = pardir + 'fMRI_Analyses/Full_Quad_ID'
