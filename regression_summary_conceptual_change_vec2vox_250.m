...
for i = 1:length(pars)
    par = pars{i};
    load(strcat('/gpfs/group/pul8/default/read/',par,'/fMRI_Analyses/Conceptual_Change/results_svd_sv2_250.mat'));
...
save('/gpfs/group/pul8/default/read/Group_Analyses/Conceptual_Change_Bilingual/results_svd_sv2_250_all_participants.mat','context','order','contextorder','sg','bow','sgbow','contextsgbow','contextordersgbow');
exit;
